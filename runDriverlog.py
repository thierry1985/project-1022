...
for i in range(1,2):
    ...
    print "Running", i
    run_str = " ./translate/TSS.py ~/workspace/temporalsase/domains/driverlogshift/domain.pddl ~/workspace/temporalsase/domains/driverlogshift/p%d.pddl > driverlog-%d-result" % (i,i)
    os.system( run_str )
