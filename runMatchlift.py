...
for i in range(1,15):
    ...
    print "Running", i
    run_str = " ./translate/TSS.py /project/cic3/huangr/TemporalSASE/domains/matchlift/domain.pddl /project/cic3/huangr/TemporalSASE/domains/matchlift/pe%d.pddl > matchlift-%d-result" % (i,i)
    os.system( run_str )
