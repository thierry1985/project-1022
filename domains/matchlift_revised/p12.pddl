(define (problem Elec4_Fuse8Floor2)
(:domain matchlift)
(:objects
        floor1 floor2  -  floor 
        match1   - match 
        ...
        elec1 elec2 elec3 elec4  -  electrician 
...
(:init
  ...
  (fuseinroom fuse2 room2c)
  (fuseinroom fuse3 room2c)
  (fuseinroom fuse4 room2c)
  (fuseinroom fuse5 room2c)
  (fuseinroom fuse6 room2c)
  (fuseinroom fuse7 room2c)
  (fuseinroom fuse8 room2c)
  (fuseinroom fuse9 room2c)
