...
(:objects
        ...
        match1 match2 match3 match4 match5   - match 
        lift1 lift2  -  lift 
...
(:init
  ...
  (fuseinroom fuse1 room1d)
  (fuseinroom fuse2 room1d)
  (fuseinroom fuse3 room4b)
  (fuseinroom fuse4 room1a)
  (fuseinroom fuse5 room4d)
  (fuseinroom fuse6 room3d)
