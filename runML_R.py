...
print "Matchlift-Revised"

for i in range(1,13):
    #./src/TSS.py /project/cic3/huangr/TemporalSASE/domain.pddl /project/cic3/huangr/TemporalSASE/domains/P2P/p1.pddl
    print "Running", i
    run_str = " ./translate/TSS.py /project/cic3/huangr/TemporalSASE/domains/matchlift_revised/domain.pddl /project/cic3/huangr/TemporalSASE/domains/matchlift_revised/p%d.pddl > matchliftRevised-%d-result" % (i,i)
    os.system( run_str )
